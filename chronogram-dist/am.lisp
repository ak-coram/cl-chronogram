 ...
 (CALENDARS
  ...
  (GREGORIAN
   ...
   (DAY-PERIODS
    (STAND-ALONE
     (NARROW
      (DEFAULT (NIGHT1 . "ሌሊት") (EVENING1 . "ማታ") (AFTERNOON1 . "ከሰዓት በኋላ")
       (MORNING1 . "ጥዋት") (PM . "ከ") (AM . "ጠ")))
     (ABBREVIATED
      (DEFAULT (NIGHT1 . "ሌሊት") (EVENING1 . "ምሽት") (AFTERNOON1 . "ከሰዓት በኋላ")
       (MORNING1 . "ጥዋት"))))
    (FORMAT
     (NARROW
     ...
     (ABBREVIATED
      (DEFAULT (NIGHT1 . "በሌሊት") (EVENING1 . "በምሽት") (AFTERNOON1 . "ከሰዓት")
       ...
       (MIDNIGHT . "እኩለ ሌሊት")))))
   (ERAS (ABBREVIATED (VARIANT (1 . "መዓ")) (DEFAULT (1 . "ዓ/ም") (0 . "ዓ/ዓ")))
