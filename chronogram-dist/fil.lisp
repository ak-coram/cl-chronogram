  ...
  (GREGORIAN
   ...
   (DAYS
    ...
    (FORMAT
     ...
     (SHORT
      (DEFAULT (SAT . "Sa") (FRI . "Bi") (THU . "Hu") (WED . "Mi") (TUE . "Ma")
       (MON . "Lu") (SUN . "Li")))
     (ABBREVIATED
      (DEFAULT (SAT . "Sab") (FRI . "Biy") (THU . "Huw") (WED . "Miy")
       (TUE . "Mar") (MON . "Lun") (SUN . "Lin")))))
   ...
   (DAY-PERIODS
    ...
    (FORMAT
     (NARROW
      (DEFAULT (NIGHT1 . "ng gabi") (EVENING1 . "sa gabi")
       (AFTERNOON1 . "sa hapon") (MORNING2 . "madaling-araw")
       (MORNING1 . "umaga") (PM . "pm") (NOON . "tanghaling-tapat") (AM . "am")
       (MIDNIGHT . "hatinggabi")))
     (ABBREVIATED
      (DEFAULT (NIGHT1 . "ng gabi") (EVENING1 . "ng gabi")
       (AFTERNOON1 . "tanghali") (MORNING2 . "madaling-araw")
       (MORNING1 . "nang umaga") (NOON . "tanghaling-tapat")
       (MIDNIGHT . "hatinggabi")))))
   (ERAS
