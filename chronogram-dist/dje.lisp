 ...
 (CALENDARS
  (GREGORIAN
   ...
   (DAYS
    (STAND-ALONE
     (NARROW
      (DEFAULT (SAT . "S") (FRI . "Z") (THU . "M") (WED . "L") (TUE . "T")
       (MON . "T") (SUN . "H"))))
    (FORMAT
     (WIDE
      (DEFAULT (SAT . "Asibti") (FRI . "Alzuma") (THU . "Alhamisi")
       (WED . "Alarba") (TUE . "Atalaata") (MON . "Atinni") (SUN . "Alhadi")))
     (ABBREVIATED
      (DEFAULT (SAT . "Asi") (FRI . "Alz") (THU . "Alm") (WED . "Ala")
   ...
   (DAY-PERIODS
    (FORMAT (WIDE (DEFAULT (PM . "Zaarikay b") (AM . "Subbaahi")))
            (ABBREVIATED (DEFAULT (PM . "Zaarikay b") (AM . "Subbaahi")))))
   (ERAS (ABBREVIATED (DEFAULT (1 . "IZ") (0 . "IJ")))
    (WIDE (DEFAULT (1 . "Isaa zamanoo") (0 . "Isaa jine"))))
