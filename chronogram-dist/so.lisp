 ...
 (CALENDARS
  ...
  (GREGORIAN
    ...
    (STAND-ALONE
     (WIDE
      (DEFAULT (12 . "Diseembar") (11 . "Noofeembar") (10 . "Oktoobar")
       (9 . "Sebteembar") (8 . "Ogosto") (7 . "Luuliyo") (6 . "Juun")
       (5 . "May") (4 . "Abriil") (3 . "Maarso") (2 . "Febraayo")
       (1 . "Jannaayo")))
     (NARROW
    ...
    (FORMAT
     (WIDE
      (DEFAULT (12 . "Bisha Laba iyo Tobnaad") (11 . "Bisha Kow iyo Tobnaad")
       ...
       (4 . "Bisha Afraad") (3 . "Bisha Saddexaad") (2 . "Bisha Labaad")
       (1 . "Bisha Koobaad")))
     (ABBREVIATED
   ...
   (DAYS
    (STAND-ALONE
     (SHORT
      (DEFAULT (SAT . "Sbti") (FRI . "Jmc") (THU . "Khms") (WED . "Arbaco")
   ...
   (DAY-PERIODS
    (STAND-ALONE (WIDE (DEFAULT (PM . "GD") (AM . "GH")))
     (ABBREVIATED (DEFAULT (PM . "GD") (AM . "AM"))))
